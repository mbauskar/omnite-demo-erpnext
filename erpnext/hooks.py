...
app_description = """## BCLOUD

BCLOUD is a fully featured ERP system designed for Small and Medium Sized
business. BCLOUD covers a wide range of features including Accounting, CRM,
Inventory management, Selling, Purchasing, Manufacturing, Projects, HR &
Payroll, Website, E-Commerce and much more.

BCLOUD is based on the Frappe Framework is highly customizable and extendable.
You can create Custom Form, Fields, Scripts and can also create your own Apps
to extend BCLOUD functionality.

BCLOUD is Open Source under the GNU General Public Licence v3 and has been
